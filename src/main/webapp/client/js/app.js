...
var myBus = angular.module('myBus', [
    ...
    'myBus.staffModule',
    'myBus.staffComplaintsModule',
    'myBus.cargoDashboard',
    'myBus.cargoBranchSummary',
    'myBus.fullTripModule',
    'myBus.collectionZoneModule',
    'myBus.inventoriesModule',
    'myBus.jobsModule',
    'myBus.remindersModule',
    'myBus.salaryReportModule',
    'myBus.expenseModule',
    'myBus.preferredStaffModule',
    'myBus.dailyTripModule',
    'myBus.layoutModules',
    'myBus.searchServiceModule',
    'myBus.serviceConfigurationModule',
    'myBus.cargoBookingChart',
    'myBus.bankModule',
    'myBus.tripSheetModule',
    'myBus.documentsUploadModule'
]);
